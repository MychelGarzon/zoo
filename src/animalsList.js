...
export const fishes = [
  ...
  { name: "Tang", likes: 0 },
  { name: "Blowfish", likes: 0 },
  { name: "Anemonefish", likes: 0 },
  { name: "Butterflyfish", likes: 0 },
  { name: "Cardinalfish", likes: 0 },
  { name: "Gourami", likes: 0 },
  { name: "Gudgeon", likes: 0 },
  { name: "Halibut", likes: 0 },
  { name: "Hogfish", likes: 0 },
  { name: "Icefish", likes: 0 },
  { name: "Jack Dempsey", likes: 0 },
  { name: "Killifish", likes: 0 },
  { name: "Lionfish", likes: 0 },
  { name: "Moray Eel", likes: 0 },
  { name: "Nudibranch", likes: 0 },
  { name: "Oscar", likes: 0 },
  { name: "shark", likes: 0 },
  { name: "Rockfish", likes: 0 },
  { name: "Rasbora", likes: 0 },
...
export const insects = [
  ...
  { name: "Spider", likes: 0 },
  { name: "Wasp", likes: 0 },
  { name: "Mantis Shrimp", likes: 0 },
  { name: "Silverfish", likes: 0 },
  { name: "Flea", likes: 0 },
  { name: "Tarantula", likes: 0 },
  { name: "Walking Stick", likes: 0 },
  { name: "Red Beetle", likes: 0 },
  { name: "Atlas Moth", likes: 0 },
  { name: "Dung Beetle", likes: 0 },
  { name: "Jewel Beetle", likes: 0 },
  { name: "Katydid", likes: 0 },
  { name: "Luna Moth", likes: 0 },
  { name: "Nymph", likes: 0 },
  { name: "Weaver Spider", likes: 0 },
  { name: "Pill Bug", likes: 0 },
  { name: "Birdwing", likes: 0 },
  { name: "Green Beetle", likes: 0 },
  { name: "Stink Bug", likes: 0 },
  { name: "Tiger Beetle", likes: 0 },
  { name: "Vinegaroon", likes: 0 },
  { name: "Water Strider", likes: 0 },
  { name: "Xylocopa", likes: 0 },
  { name: "Yellowjacket", likes: 0 },
  { name: "Canario", likes: 0 },
  { name: "Aphid", likes: 0 },
  { name: "Blue Butterfly", likes: 0 },
  { name: "Cicada", likes: 0 },
  { name: "African Ant", likes: 0 },
  { name: "Earwig", likes: 0 },
  { name: "Fruit Fly", likes: 0 },
  { name: "Goliath Beetle", likes: 0 },
];
